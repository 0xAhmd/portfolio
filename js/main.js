// Main JavaScript file for Ahmed Hesham's Portfolio
...
function initHoverEffects() {
    ...
    document.querySelectorAll('.skill-tag').forEach(tag => {
        tag.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 5px 15px rgba(119, 119, 198, 0.3)';
        });
    ...
    document.querySelectorAll('.achievement-card').forEach(card => {
        card.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 25px 60px rgba(119, 119, 198, 0.4)';
        });
...
function initAchievementAnimations() {
    ...
    achievementCards.forEach(card => {
        ...
        card.addEventListener('click', function() {
            ...
            ripple.style.background = 'rgba(119, 119, 198, 0.3)';
...
style.textContent = `
    ...
    @keyframes glow {
        0%, 100% {
            box-shadow: 0 0 5px rgba(119, 119, 198, 0.5);
        }
        50% {
